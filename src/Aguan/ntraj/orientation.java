...
public class orientation{
    private log LOG;
    public orientation(TheMatrix TM){
    ...
    public void HistogramWaters(TheMatrix TM, double timeNow){
      ...
      //          LOG.lout.printf("     rx2[%d]=%3.3f   ry2[%d]=%3.3f   rz2[%d]=%3.3f\n",m,rx2[m],m,ry2[m],m,rz2[m]);
      //          LOG.lout.printf("      rx[%d]=%3.3f    ry[%d]=%3.3f    rz[%d]=%3.3f\n",m,((TM.rx[n]+tx)*TM.ro),m,((TM.ry[n]+ty)*TM.ro),m,((TM.rz[n]+tz)*TM.ro));
            }
      ...
      //        LOG.lout.printf("     distHHx=%3.3f    distHHy=%3.3f    distHHz=%3.3f  = %d\n",distHHx,distHHy,distHHz,TM.q);
                    if(TM.q == 0){TM.q0++;
        ...
        LOG.lout.printf("%5.4f %.1f %.1f %.1f %.1f %.1f %.1f ",(timeNow*1.6),t0,t1,t2,t3,t4,t5);
        LOG.lout.printf("%s %s %s %.2f %.2f %.2f \n",sx,sy,sz,rvx,rvy,rvz); 
        //LOG.lout.printf(" %d %d %d %d %d %d",TM.q10,TM.q21,TM.q30,TM.q32,TM.q40,TM.q41);
        //LOG.lout.printf(" %d %d %d %d %d %d",TM.q42,TM.q43,TM.q50,TM.q51,TM.q52,TM.q53);
        //LOG.lout.printf(" %d %d %d %d %d %d %d %d\n",TM.q410,TM.q421,TM.q430,TM.q432,TM.q510,TM.q521,TM.q530,TM.q532);
    }
